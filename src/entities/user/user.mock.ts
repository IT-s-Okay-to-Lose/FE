...
export const mockPendingOrderData: OrderHistoryItem[] = [
  ...
  {
    orderId: 2,
    createdAt: new Date("2025-04-27T08:45:00"),
    orderType: "BUY",
    quantity: 30,
    price: 15000,
    status: "PENDING",
...
export const mockCompletedOrderData: OrderHistoryItem[] = [
  ...
  {
    orderId: 5,
    createdAt: new Date("2025-04-26T14:50:00"),
    orderType: "SELL",
    quantity: 80,
    price: 14000,
    status: "DONE",
...
export const mockRealizedSummary: RealizedSummary = {
  totalIncome: 50000,
...
export const mockRealizedDetail: RealizedDetail[] = [
  {
    date: "2025-06-28",
    items: [
      {
...
export const mockHoldingRatio: HoldingRatio[] = [
  {
    stockName: "엔비디아",
    percent: 48.8,
    color: "#FF6384",
